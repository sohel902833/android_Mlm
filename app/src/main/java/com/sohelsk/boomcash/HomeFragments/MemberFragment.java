...
import com.sohelsk.boomcash.Adapter.MemberShipListAdapter;
...
import com.sohelsk.boomcash.PurchasePackageActivity;
...
public class MemberFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(currentMembership.getLevelName()!=null && currentMembership.getLevelId()!=null && currentMembership.getMonthlyIncome()!=null){
            ...
            currentMembershipTv.setText(currentMembership.getLevelName()+" : "+currentMembership.getPrice()+" USDT");
            numOfJobsTv.setText("Number Of Jobs Per Day: "+currentMembership.getNumOfJobs());
            monthlyIncomeTv.setText("Monthly Income : "+currentMembership.getMonthlyIncome()+" USDT");
