...
import com.sohelsk.boomcash.Adapter.MessageAdapter;
...
public class ChatingActivity extends AppCompatActivity {
    ...
    private DatabaseReference messageRef, conversationRef, newMessageRef;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        newMessageRef = FirebaseDatabase.getInstance().getReference().child("NewMessage");
    ...
    private void init() {
        imageView = findViewById(R.id.imageShowImageView);
    ...
    protected void onStart() {
        ...
        Query query = messageRef.child("" + userDb.getUserData().getUserId()).orderByChild("messageId");
    ...
    private void setNewMessage() {
        ...
        newMessageMap.put("userId", userDb.getUserData().getUserId());
        newMessageMap.put("name", userDb.getUserData().getName());
        newMessageRef.child("" + userDb.getUserData().getUserId())
                .updateChildren(newMessageMap);
    }
