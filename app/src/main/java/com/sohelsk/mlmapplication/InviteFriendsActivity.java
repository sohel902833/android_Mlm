...
public class InviteFriendsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        referCodeTextView.setText(""+userDb.getUserData().getMyReferCode());
        referLinkTextView.setText(("https://www.amd.com/login?referCode="+userDb.getUserData().getMyReferCode()));
