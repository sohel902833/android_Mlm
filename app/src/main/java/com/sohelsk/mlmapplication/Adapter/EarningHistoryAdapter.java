...
import com.sohelsk.mlmapplication.DataModel.EarningHistoryModel;
import com.sohelsk.mlmapplication.DataModel.WithdrawModel;
...
public class EarningHistoryAdapter extends RecyclerView.Adapter<EarningHistoryAdapter.MyViewHolder>{
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.earnFormTv.setText("Earn Form : "+earningHistory.getText());
